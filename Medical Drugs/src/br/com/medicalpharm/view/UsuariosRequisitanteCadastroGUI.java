 ...
 * @author William
 */
public class UsuariosRequisitanteCadastroGUI extends javax.swing.JFrame {

    /**
     * Creates new form UsuariosRequisitanteCadastro
     */
    public UsuariosRequisitanteCadastroGUI() {
        initComponents();
        this.setLocationRelativeTo(null);
        
    }
    UsuarioRequisitanteGerenciarGUI telaPai;
    UsuariosRequisitanteConsultarGUI telaPai2;
    ...
    public void codigoCarregar(){
        if(update){
            ...
            tf_codigo.setText(usuarioControl.gerarCodigo()+"");
        }
    }
...
//        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosRequisitanteCadastroGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosRequisitanteCadastroGUI().setVisible(true);
            }
        });
    }
