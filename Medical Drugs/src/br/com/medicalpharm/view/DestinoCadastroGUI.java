 ...
 * @author ALENCAR
 */
public class DestinoCadastroGUI extends javax.swing.JFrame {

    public DestinoGUI janelapai;
    public SaidaEstoqueGUI janelapai2;
    public ArmazemCadastroGUI janelapai3;
    List<ArmazemModel> destinos;

    /** Creates new form DestinoCadastroGUI */
    public DestinoCadastroGUI() {
        initComponents();
        janelapai = null;
        janelapai2 = null;
        janelapai3 = null;
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new DestinoCadastroGUI().setVisible(true);
            }
        });
    }
    ...
    public boolean verificarCampos() {
        ...
        if (jtf_descricao.getText().length() > 45) {
    ...
    public void verificaCadastro() {
        ...
        destinos = dest.listarDestinoDescricao(jtf_descricao.getText().trim());
        validaCadastro(destinos);
    }

    public void validaCadastro(List<ArmazemModel> destino) {//verifica cadastro existente que retornou de uma lista
