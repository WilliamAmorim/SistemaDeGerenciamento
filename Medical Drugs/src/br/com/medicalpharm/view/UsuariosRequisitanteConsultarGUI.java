 ...
 * @author willi
 */
public class UsuariosRequisitanteConsultarGUI extends javax.swing.JFrame {
    List<UsuarioRequisitanteModel> usuarios;
    /**
     * Creates new form UsuariosRequisitanteConsultarGUI
     */
    public UsuariosRequisitanteConsultarGUI() {
        initComponents();
...
// pegarUsuario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosRequisitanteConsultarGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosRequisitanteConsultarGUI().setVisible(true);
            }
        });
    }
